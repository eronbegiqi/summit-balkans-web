            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-gray-200 px-3.5 py-2.5 pr-10 text-sm text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-transparent focus:ring-2"
                  style={{ '--tw-ring-color': '#2e8a57' } as React.CSSProperties}
                  placeholder="••••••••"
                />
                <button
